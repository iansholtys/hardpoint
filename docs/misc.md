...
We should allow for going overweight but having a reduction in vehicle performance. The performance of a vehicle would be 'nominal' at certain available amounts of power.

If you have the hardpoints you can always install multiple engines. :)

---

## Vehicle Performance

A vehicle cannot go below a Performance level of -3 (just like it cannot go above +3).
